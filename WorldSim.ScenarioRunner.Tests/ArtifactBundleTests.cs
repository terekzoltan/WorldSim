...
public sealed class ArtifactBundleTests
{
    ...
    public void ArtifactBundle_PerRunFilesExist()
    {
        ...
        foreach (var file in files)
        {
            ...
            Assert.True(ecologyTelemetry.TryGetProperty("emergencyRescues", out _));
            Assert.True(ecologyTelemetry.TryGetProperty("emergencyRescuePolicy", out _));
            Assert.True(ecologyTelemetry.TryGetProperty("lastEmergencyRescueReason", out _));
            ...
            Assert.True(ecologyBalance.TryGetProperty("emergencyRescuePolicy", out _));
