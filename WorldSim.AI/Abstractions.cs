...
public readonly record struct NpcAiContext(
    ...
    bool IsColonyUnderSiege = false,
    bool IsNearActiveSiege = false,
    bool HasRecentBreachNearby = false,
    int NearbyEnemyDefensiveStructures = 0,
    int NearbyEnemyTowerCount = 0,
    int NearbyEnemyWallCount = 0,
    int NearbyFriendlyTowerCount = 0,
    int NearbyFriendlyWallCount = 0,
    float NearbySiegePressure = 0f,
    bool IsSiegeAttackerRole = false,
