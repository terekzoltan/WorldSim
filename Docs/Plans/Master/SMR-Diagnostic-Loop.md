...
## Current E11-H application

The existing four-case package is complete at GREEN/ACK_ONLY, pending its own
closeout. This guidance does not authorize rerunning it. A possible next question
