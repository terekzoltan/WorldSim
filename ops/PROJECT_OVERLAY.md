...
- Accountable role overlay: `../Docs/Plans/Meta-Coordinator-Runbook.md`

Owner instructions, WorldSim target state, the active Combined heading, the pinned stage artifact, and project role boundaries remain authoritative. FAL is transport/evidence continuity only and cannot replace target truth.
