...
public sealed record HudTheme(
    ...
    Color AccentText,
    Color EventText,
    Color CombatEventText,
    Color SiegeEventText,
    Color CampaignEventText,
    Color DirectorEventText,
    Color StatusText,
...
)
{
    public static HudTheme Default { get; } = new(
        ...
        CombatEventText: new Color(236, 156, 126),
        SiegeEventText: new Color(232, 178, 126),
        CampaignEventText: new Color(146, 206, 237),
        DirectorEventText: new Color(193, 165, 241),
    ...
    public static HudTheme FromWorldTheme(WorldSim.Graphics.Rendering.WorldRenderTheme theme)
    {
        return new HudTheme(
            ...
            EventText: Color.LightGray,
            CombatEventText: theme.Warning,
            SiegeEventText: Color.Lerp(theme.Warning, theme.Highlight, 0.45f),
            CampaignEventText: Color.Lerp(theme.Highlight, Color.LightCyan, 0.35f),
            DirectorEventText: Color.Lerp(theme.Highlight, new Color(178, 140, 233), 0.55f),
            StatusText: Color.LightCyan,
